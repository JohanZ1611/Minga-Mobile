  ...
  return (
    <View style={{flex:1}}>
      <View style={{flex:0.15,paddingHorizontal:25,display:'flex',flexDirection:'row',alignItems:'center',gap:10}}>
        {token?<Image source={{ uri: user?.photo || '' }} style={{height:65,width:65,borderRadius:50}}/>:<Image source={require('../../img/photoProfile.png')} style={{height:65,width:65,borderRadius:50}}/>}
